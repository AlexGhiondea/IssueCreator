...
namespace IssueCreator
{
    public class IssueManager
    {
        ...
        public async Task<(bool, string)> TryCreateNewIssueAsync(IssueToCreate issueToCreate, bool openBrowserAfterCreate = true)
        {
            ...
            try
            {
                ...
                if (issueToCreate.Epic != null)
                {
                    ...
                    if (!result)
                    {
                        return (false, "Cannot associate issue to epic");
                    }
                }
                ...
                if (estimate > 0)
                {
                    ...
                    if (!result)
                    {
                        return (false, "Cannot set issue estimate");
                    }
                }
                ...
                if (issueToCreate.CreateAsEpic)
                {
                    ...
                    if (!result)
                    {
                        return (false, "Cannot convert issue to epic");
                    }
                }
            }
            catch (Exception ex)
        ...
        public void RemoveRepoFromCache(string owner, string repo)
        {
            _cache.Remove(StringTemplate.Repo(owner, repo));
        }

        public void RemoveEpicFromCache(string owner, string repo)
        {
